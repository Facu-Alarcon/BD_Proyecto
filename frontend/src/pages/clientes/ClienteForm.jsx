      ...
      <div className="card" style={{ padding: 28, maxWidth: 520 }}>
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-field">
            ...
            <input id="nombre_cliente" value={form.nombre_cliente} onChange={(e) => actualizar('nombre_cliente', e.target.value)} required />
          ...
          <div className="form-field">
            ...
            <input id="apellido_cliente" value={form.apellido_cliente} onChange={(e) => actualizar('apellido_cliente', e.target.value)} required />
          ...
          <div className="form-field">
            ...
            <input id="domicilio_cliente" value={form.domicilio_cliente} onChange={(e) => actualizar('domicilio_cliente', e.target.value)} required />
          ...
          <div className="form-field">
            ...
            <input id="telefono_cliente" type="number" value={form.telefono_cliente} onChange={(e) => actualizar('telefono_cliente', e.target.value)} required />
            {errores.telefono_cliente && <span className="form-error">{errores.telefono_cliente}</span>}
          </div>

          <div className="form-field">
            <label htmlFor="email_cliente">Email</label>
            <input id="email_cliente" type="email" value={form.email_cliente} onChange={(e) => actualizar('email_cliente', e.target.value)} required />
